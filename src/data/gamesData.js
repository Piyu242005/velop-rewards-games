...
const gamesData = [
  {
    ...
    playable: true,
    guide: [
      'Tap or click to shoot incoming enemies.',
      'Dodge asteroids — they cost you a life.',
      'Destroy wave bosses to earn bonus coins.',
      'Survive as long as possible to maximise your score.',
      'Your score converts to Game Coins at the end.',
    ],
  },
  {
    id: 2,
    ...
    playable: true,
    guide: [
      'Click or tap a group of 2+ matching fruits to blast them.',
      'Larger groups score bigger multipliers.',
      'Clear the board or reach the target score to win the round.',
      'You get 3 lives — use them wisely.',
      'Every 500 points earns you 1 Game Coin.',
    ],
  },
  {
    id: 3,
